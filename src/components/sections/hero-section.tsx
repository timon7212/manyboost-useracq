      ...
      >
        ...
        <div className="flex flex-col items-center">
          <div className="mb-3 text-center">
            <p className="text-[28px] font-medium leading-none tracking-[-0.02em] gradient-text">400M+</p>
            ...
            <p className="text-[12px] leading-[1.3] font-medium gradient-text">Creators</p>
          </div>
      ...
      >
        ...
        >
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="mb-3 text-center">
              <p className="text-[32px] lg:text-[36px] font-medium leading-none tracking-[-0.02em] gradient-text">400M+</p>
              ...
              <p className="text-[13px] lg:text-[14px] leading-[1.3] font-medium gradient-text">Creators</p>
            </div>
            {/* Stacked creator photos */}
